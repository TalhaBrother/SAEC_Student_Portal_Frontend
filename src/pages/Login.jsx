        ...
        <div className="w-full max-w-md mx-auto my-auto">
              ...
              className={`mb-5 rounded-xl border p-4 text-sm ${
                loginErrorType === 'license'
                  ...
                  : loginErrorType === 'server'
                    ? 'border-[var(--info)]/20 bg-[var(--info)]/5 text-[var(--info)]'
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold uppercase tracking-wider text-[var(--neutral-600)] block">
                Username
              </label>
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  required
                  className="w-full bg-[var(--surface)] text-[var(--quinary)] border border-[var(--neutral-200)] rounded-xl px-4 py-3 text-sm placeholder:text-[var(--neutral-400)] outline-none focus:border-[var(--primary)] focus:ring-4 focus:ring-[var(--primary)]/10 transition-all duration-200 shadow-sm"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  required
                  className="w-full bg-[var(--surface)] text-[var(--quinary)] border border-[var(--neutral-200)] rounded-xl px-4 py-3 pr-11 text-sm placeholder:text-[var(--neutral-400)] outline-none focus:border-[var(--primary)] focus:ring-4 focus:ring-[var(--primary)]/10 transition-all duration-200 shadow-sm"
                />

                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3.5 text-[var(--neutral-400)] hover:text-[var(--neutral-600)] transition-colors focus:outline-none cursor-pointer"
                  tabIndex="-1"
                >
                  {showPassword ? (
                    <svg
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[var(--primary)] hover:opacity-95 disabled:opacity-50 text-[var(--surface)] font-bold py-3.5 px-4 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.99] cursor-pointer text-sm tracking-wider uppercase mt-2 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
                  <svg
                    className="animate-spin h-4 w-4 text-[var(--surface)]"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                  >
...
<div className="mt-5">
  ...
  <button
    ...
    className="w-full border border-[var(--neutral-200)] bg-[var(--surface)] hover:bg-[var(--neutral-50)] disabled:opacity-50 text-[var(--neutral-700)] font-semibold py-3 px-4 rounded-xl transition-all duration-200 shadow-sm hover:shadow flex items-center justify-center gap-2 cursor-pointer text-sm"
  >
    {hwidLoading ? (
      <>
        <svg
  ...
  {hwid && (
    <div className="mt-3 rounded-xl border border-[var(--neutral-200)] bg-[var(--neutral-50)] p-4">
      ...
      <div className="bg-[var(--surface)] border border-[var(--neutral-200)] rounded-lg px-3 py-2">
        <code className="block text-xs sm:text-sm text-[var(--neutral-700)] break-all select-all">
          {hwid}
        </code>
      </div>
      ...
      <p className="mt-2 text-[10px] text-[var(--neutral-400)]">
        ...
        <div className="w-full max-w-md mx-auto pt-6 border-t border-[var(--neutral-200)]/60 text-center relative">
          <div className="text-xs font-medium text-[var(--neutral-400)] tracking-wide">
            ...
            <span className="relative inline-block group cursor-pointer text-[var(--quinary)] font-bold underline decoration-dotted underline-offset-4">
              ...
              <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-0.5 hidden group-hover:flex flex-col gap-2 bg-[var(--surface)] p-3.5 rounded-2xl shadow-xl border border-[var(--neutral-100)] text-left min-w-[190px] z-30 transition-all duration-200">
                ...
                <a
                  ...
                  className="flex items-center justify-between p-2 rounded-xl hover:bg-[var(--success)]/5 text-xs font-semibold text-[var(--neutral-700)] hover:text-[var(--success)] transition-colors group/link"
                >
                  ...
                  <span className="text-[10px] opacity-0 group-hover/link:opacity-100 transition-opacity text-[var(--success)] font-bold">
                    Chat →
                  </span>
                </a>
                ...
                {/* Tail / Arrow */}
                <span className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-3 h-3 bg-[var(--surface)] border-b border-r border-[var(--neutral-100)] rotate-45" />
              </span>
            </span>
          </div>
        </div>
      ...
      <div className="hidden md:flex md:w-1/2 bg-[var(--primary)] p-12 flex-col items-center justify-center relative overflow-hidden select-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[var(--surface)]/10 via-transparent to-[var(--quinary)]/20 pointer-events-none" />
        <div className="absolute -top-24 -left-24 w-96 h-96 bg-[var(--surface)]/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-[var(--quinary)]/20 rounded-full blur-3xl" />

        {/* Prominent Institute Logo Stage */}
        <div className="z-10 flex flex-col items-center justify-center max-w-lg w-full text-center">
          <div className="relative group p-10 bg-[var(--surface)]/10 backdrop-blur-2xl rounded-3xl border border-[var(--surface)]/20 shadow-2xl transition-all duration-500 hover:scale-[1.02]">

            {/* Glow backing behind logo image */}
            <div className="absolute inset-0 bg-[var(--surface)]/20 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

            {showSkeleton ? (
              <div className="relative z-10 h-[320px] w-[320px] max-w-full max-h-[320px] rounded-2xl bg-[var(--surface)]/10 animate-pulse" />
            ) : logoUrl ? (
              <img
                src={logoUrl}
              ...
              <div className="relative z-10 h-[320px] w-[320px] max-w-full flex items-center justify-center rounded-2xl bg-[var(--surface)]/10 text-[var(--surface)]/40 text-xs font-semibold uppercase tracking-wider">
                No Logo Configured
              </div>
            )}
          </div>
          ...
          <div className="mt-8 space-y-1.5 w-full">
            {showSkeleton ? (
              <>
                <div className="h-7 w-56 mx-auto rounded-lg bg-[var(--surface)]/20 animate-pulse" />
                <div className="h-3 w-72 mx-auto rounded bg-[var(--surface)]/10 animate-pulse mt-3" />
              </>
            ) : (
              <>
                <h2 className="text-[var(--surface)] text-2xl font-bold tracking-tight">
                  {instituteName || 'Institute Name Not Set'}
                </h2>

                <p className="text-[var(--surface)]/70 text-xs font-medium uppercase tracking-widest">
                  {tagline}
                </p>
              </>
            )}
