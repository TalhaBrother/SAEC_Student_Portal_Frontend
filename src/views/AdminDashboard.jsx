...
export default function AdminDashboard() {
  ...
  return (
    <>
      ...
      {!SelectedClass ? (
        <div className="bg-surface rounded-xl border border-neutral-100 p-8 shadow-sm text-center text-neutral-400 text-sm">
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="lg:col-span-2 bg-surface rounded-xl border border-neutral-100 p-5 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-base font-semibold text-quinary">
                  Class average per test
                </h2>
                <span className="text-xs text-neutral-400">{AttendanceData.class}</span>
              </div>
              <BarChart
            ...
            <div className="bg-surface rounded-xl border border-neutral-100 p-5 shadow-sm">
              <h2 className="text-base font-semibold text-quinary mb-4">
          ...
          <div className="bg-surface rounded-xl border border-neutral-100 p-5 shadow-sm mt-4">
            <h2 className="text-base font-semibold text-quinary mb-4">
              Recent activity
            </h2>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {AttendanceData.student_summaries.map((s) => (
                    ...
                    >
                      <td className="py-2 pr-4 text-quinary font-medium">
                        {s.full_name}
                      </td>
                      <td className="py-2 pr-4 text-neutral-600">{s.present}</td>
                      <td className="py-2 pr-4 text-neutral-600">{s.absent}</td>
                      <td className="py-2 pr-4 text-neutral-600">{s.percentage}%</td>
                    </tr>
                  ))}
                </tbody>
              </table>
